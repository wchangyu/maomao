$(function() {
    ...
    //选中的能耗种类id
    var _energyTypeValue = $('.left-choose-energy-container .time-radio:checked').attr('data-id');

    //选中能耗种类名称
    var _energyTypeWord = $('.left-choose-energy-container .time-radio:checked').parents('.choose-energy').find('label').html();
    ...
    $('.left-choose-energy-container .time-radio').on('change',function(){
        ...
        //选中的能耗种类id
         _energyTypeValue = $('.left-choose-energy-container .time-radio:checked').attr('data-id');

        //选中能耗种类名称
         _energyTypeWord = $('.left-choose-energy-container .time-radio:checked').parents('.choose-energy').find('label').html();
    ...
    function conditionalSearch() {
        ...
        //获取时间维度
        var Ttype = $('.choose-time font').html();
        ...
        if(Ttype == '日'){
            ...
            et = moment($('.min').val()).add(1,'d').format('YYYY-MM-DD');
            ...
            st = moment($('.min').val()).startOf('month').format('YYYY-MM-DD');

            et = moment($('.min').val()).endOf('month').add(1,'d').format('YYYY-MM-DD');

        }else if(Ttype == '年'){

            st = moment($('.min').val()).startOf('year').format('YYYY-MM-DD');

            et = moment($('.min').val()).endOf('year').add(1,'d').format('YYYY-MM-DD');
        ...
        if(jsonText){
            ...
            for(var i=0;i<jsonText.alltypes.length;i++){
                ...
                if(jsonText.alltypes[i].etid == _energyTypeValue){
                    ...
                    $('.right-header-title').eq(1).html('昼夜分析');
