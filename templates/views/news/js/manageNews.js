    ...
    "columns": [
        ...
        },
        {
            ...
            render:function(data, type, row, meta){
                ...
                if(userRole == 'admin' || row.isApl == 0){

                    html +=  "<span class='data-option option-edite btn default btn-xs green-stripe'><a href='../news/addNews.html?id=" +
                        row.id + '&flag=1' +
                        "'>编辑</a></span>" ;
...
if(userRole == 'admin'){
    ...
    searchUrl = 'HBYYG/GetUserNewsContentByType';
