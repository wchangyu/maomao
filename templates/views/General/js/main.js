var Main = function () {
        ...
        $.post(url,{
            ...
            if(res.code===0){
                ...
                if(sessionStorage.misc == 1){
                    ...
                    var name = ["Real-Time Efficiency(KW/KW)","折标能效"];

                }else if(sessionStorage.misc == 2){

                    var name = ["Real-Time Efficiency(KW/RT)","折标能效"];
        ...
        $.post(url,{
            ...
            if(res.code===0){
                ...
                if(sessionStorage.misc == 1){
                    ...
                    name = ["Real-Time Efficiency(KW/KW)"];

                }else if(sessionStorage.misc == 2){

                    name = ["Real-Time Efficiency(KW/RT)"];
    ...
    var initNOEWPowerChartView = function () {
        ...
        $.post(url,{
            ...
            if(res.code===0){
                ...
                for (var i = 0; i < res.ys.length; i++) {
                    var object = {};
                    object.name = "Real-Time Power Curve(KW)";
                    object.type = "line";
                    object.data = [];
                    for (var j = 0; j < res.ys[i].length; j++) {
                        var v = res.ys[i][j];
                ...
                option.legend.data[0] = 'Real-Time Power Curve(KW)';
        ...
        $.post(url,{
            ...
            if(res.code===0){
                ...
                if(sessionStorage.misc == 1){
                    ...
                    resLgs = ["Coolant output capacity(KW)", "Coolant power(KW)", "Heat Dissipating index(KW)", "Thermal unbalance rate(%)"]

                }else if(sessionStorage.misc == 2){

                    resLgs = ["Coolant output capacity(RT)", "Coolant power(KW)", "Heat Dissipating index(RT)", "Thermal unbalance rate(%)"]
    ...
    var initEAnMoNistorysglDs = function () {
        ...
        $('.mopenhistoryds').on('click', function () {
            ...
            $('#myModalLabel').html(title + ' Historical curve');
