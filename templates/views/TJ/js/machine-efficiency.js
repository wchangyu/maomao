...
$(function(){
    ...
    if(sessionStorage.misc == 1){
        ...
        col = [
            ...
            {
                title:'整体值<span class="Lunite"></span>',
                data:'totalV',
                render:function(data, type, row, meta){
                    ...
                    if(row.kpiN == 'PLF'){
                        ...
                        thisValue = (Math.random() * 5 / 100 + 0.1);
                    ...
                    if(row.kpiN == 'CLF'){
                        ...
                        thisValue = (Math.random() * 15 / 100 + 0.3);
            ...
            {
                title:'平均值<span class="Lunite"></span>',
                data:'maxV',
                render:function(data, type, row, meta){
            ...
            {
                title:'10%最优平均值<span class="Lunite"></span>',
                data:'minV',
                render:function(data, type, row, meta){
            ...
            {
                title:'10%最差平均值<span class="Lunite"></span>',
                data:'averV',
                render:function(data, type, row, meta){
    ...
    function devTree(arr){
        ...
        for(var i=0;i<arr.length;i++){
            ...
            if(arr[i].pid == 0 && arr[i].id != 3 ){

                if(treeNum < 3){

                    obj.id = arr[i].id;
                    obj.name = treeNameArr[treeNum];
                    obj.pId = arr[i].pid;
                    obj.item = arr[i].item;
                    treeArr.push(obj);
        ...
        for(var i=0;i<node.length;i++){
            ...
            zTreeObj.checkNode(node[0],true);
                        ...
                        for(var i=0;i<result.ys.length;i++){
                            ...
                            for(var j=0;j<result.ys[i].length;j++){
                                ...
                                if(namesArr[0] == 'PUE'){
                                  ...
                                  thisValue = (Math.random() * 15 / 100 + 1.5);
