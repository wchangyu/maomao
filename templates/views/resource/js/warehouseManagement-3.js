   ...
   var myApp33 = new Vue({
    ...
    var workDone = new Vue({
        ...
        methods:{
            ...
            focusSn:function(e){
                ...
                $('.accord-with-list').eq(2).empty();
                $('.accord-with-list').eq(2).append(str);
            },
            keySn:function(e){
    ...
    $('.pinzhixx').eq(1)
        .on('click','div',function(e){
            workDone.gdCode = $('.pinzhixx').eq(1).children('.li-color').html();
