$(function(){
    ...
    ajaxFun('YWGD/ywGDWxxmGetAll',_allDataXM,_$tableXM,'wxname');
    /*--------------------------------按钮事件--------------------------*/
    //tab切换
    ...
    $('#myModal .modal-dialog').find('.modal-footer').on('click','.dengji',function(){
        ...
        if( myApp33.sblxmc == '' || myApp33.pyjm == ''){
            ...
            if(myApp33.sbxt == ''){
                ...
                $('#myModal').modal('hide');
                //获取填写的内容
                    xinzengFun('YWGD/ywGDWxxmCreate','wxname','memo','wxclassnum','wxclassname','workhour','workfee');
        ...
        .on('click','.xiugai',function(){
            ...
            if( myApp33.sblxmc == '' || myApp33.pyjm == ''){
                ...
                if(myApp33.sbxt == ''){
                    ...
                    bianjiFun('YWGD/ywGDWxxmUpdate','wxnum','wxname','memo','wxclassnum','wxclassname',"workhour","workfee");
    ...
    $('#myModal1').on('click','.shanchu',function(){
        if( _$thisTable[0].id == _stringLB ){
            ...
            shanchu('YWGD/ywGDWxxmDelete','id');
        }
    })
    //确定关闭模态框按钮
            ...
            success:function(result){
                if(result == 99){
                    if(_$thisTable[0].id == _stringLB){
                        ...
                        shebeiHQ('YWGD/ywGDWxxmGetAll',_allDataXM,_$thisTable);
                    }
            ...
            success:function(result){
                if(result == 99){
                    ...
                    if( _$thisTable[0].id == _stringLB ){
                        ...
                        shebeiHQ('YWGD/ywGDWxxmGetAll',_allDataXM,_$thisTable,true);
                    }
                    var $myModal = $('#myModal2');
    ...
    function shanchu(url,text){
        ...
        //console.log(parseInt(_tableColumID));
