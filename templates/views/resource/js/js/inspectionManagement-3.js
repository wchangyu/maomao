$(function(){
   ...
   //巡检内容表格
                ...
                "render":function(data, type, full, meta){
                    if(data == 0){
                        return "<span class='data-option option-see btn default btn-xs green-stripe'>查看</span>" +
                            ...
                            "<span class='data-option option-assign btn default btn-xs green-stripe' title='启用并分配任务'>启动巡检计划</span>"
                    }if(data !=0){
                        return "<span class='data-option option-see btn default btn-xs green-stripe'>查看</span>" +
                            "<span class='data-option option-delete btn default btn-xs green-stripe'>删除</span>"
                    }
    ...
    /*_table.find('tbody').on( 'click', 'td', function () {
        //alert( _tables.cell( this ).data() );
        var cell = _tables.cell( this );
