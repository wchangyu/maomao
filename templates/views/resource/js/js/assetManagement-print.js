            ...
            success:function(result){
                ...
                for(var i=0;i<result.length;i++){
                    ...
                    var  valueStr = '<div class="print-block-cel suo"> <div class="table-title1">设备（设施）标识牌</div> <div class="table-img1"> <img src="../resource/img/jt-logo.png" alt=""> <span>江铁实业</span> </div> <div class="title-word1">' + result[i].ddName +
                        ...
                        '</div> </div> <div class="row-list"> <div class="row-three-left">产权单位</div> <div class="row-three-right">中国铁路南昌局集团有限公司</div> </div> <div class="row-list"> <div class="row-three-left">维护单位</div> <div class="row-three-right">江西铁路实业发展有限公司</div> </div> </div> <div class="img-block"> <img  src="' + _replaceIP(_erweimaPath,_urls) + '?asc=' + result[i].dNum +
