$(function(){
    ...
    var devCol = [

        {
            ...
            render:function(data, type, full, meta){
                ...
                return  '<div class="checker" data-id="' + full.dNum + '"><span><input type="checkbox"                                 value=""></span></div>'
    ...
    _tableInit($('#dev-table'),devCol,2,'','','','','',10);
    ...
    $('#select-Dev').click(function(){
        ...
        if( department == '' || system == '' ){
            ...
            _moTaiKuang($('#tip-modal'), '提示', true, 'istap' ,'请先选择车站和系统类型', '');
    ...
    function choiceDevice(flag){
        ...
        _mainAjaxFunCompleteNew('post','YWDev/ywDIGetDevsII',prm,$('#DEV-Modal').find('.modal-content'),function(result){
