$(function(){
    ...
    //初始化时间控件
    _timeYMDComponentsFun11_EN($('.abbrDT'));
    ...
    if(sessionStorage.misc == 1){
        ...
        col = [
            ...
            {
                title:'Total Value <span class="Lunite">(KWH)</span>',
                data:'totalV'
            },
            {
                title:'Peak Value <span class="Lunite">(KWH)</span>',
                data:'maxV'
            },
            {
                title:'Occurrence',
            ...
            {
                title:'Valley Value <span class="Lunite">(KWH)</span>',
                data:'minV'
            },
            {
                title:'Occurrence',
            ...
            {
                title:'Averaged Value <span class="Lunite">(KWH)</span>',
                data:'averV'
            }
        ...
        col = [
            ...
            {
                title:'Total Value <span class="Lunite">(KWH/RTH)</span>',
                data:'totalV'
            },
            {
                title:'Peak Value <span class="Lunite">(KWH/RTH)</span>',
                data:'maxV'
            },
            {
                title:'Occurrence',
            ...
            {
                title:'Valley Value <span class="Lunite">(KWH/RTH)</span>',
                data:'minV'
            },
            {
                title:'Occurrence',
            ...
            {
                title:'Averaged Value <span class="Lunite">(KWH/RTH)</span>',
                data:'averV'
            }
