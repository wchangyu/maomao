$(function(){
    ...
    },"The target is less than the alarm");
    ...
    },"The alarm is less than the target.");
    ...
    $('#devOption').click(function(){
        ...
        if(_isCreate){
            ...
            //需要创建
            _moTaiKuang($('#devModal'),'Equipment Setting',false,false,false,'Save');
                        ...
                        {name : '年最高', value : ReData, xAxis: ReData, y: 50,
                            ...
                            label:{
                                ...
                                formatter:function (params,ticket,callback){
                                    ...
                                    return 'Current：(' + params.data.value + '%)'
    ...
    function RBPHBC(data){
        ...
        $('#RBPHL-word').css({'left':left-40,'color':color}).html('Current（'+ data + '%' + ')');
