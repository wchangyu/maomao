        ...
        },
        {
            ...
            "render":function(data,type,row,meta){
                ...
                if(row.childDevAlarmNumPopupReturns.length > 0){
                    ...
                    return  "<button class='btn details-control' data-alaLogID="+data+" >show or hide history</button>"
                }else{
...
var _maintainoption = {
    ...
    series : [
        {
            name: 'Service Situation',
            type: 'pie',
            radius : '85%',
            center: ['50%', '50%'],
            data:[
                {value:0, name:'Repaired'},
                {value:0, name:'Non Repaired'}
            ],
            itemStyle: {
                normal : {
...
function alarmHistory(){
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            var dataArr = [
                {value:endRepairNum, name:'Repaired',label:{padding:[20,0,0,0]}},
                {value:noRepairNum, name:'Non Repaired'}
            ];
