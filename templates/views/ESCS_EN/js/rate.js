var Rate=function () {
    ...
    var getRateDs = function () {
        ...
        $.post(url,{
            ...
            if(res.code===0){
                ...
                console.log('Error(Histogram Load):' + res.msg);
    ...
    _tableInit_EN($('#tableED'),col,2,true,'','',true,'','',false);
    ...
    $('#devOption').click(function(){
        ...
        //模态框
        _moTaiKuang($('#option-Modal'), 'Rated Cooling Load Setting', '', '' ,'', 'Confirm');
    ...
    $('#tableED tbody').on('click','.EDValue',function(){
        ...
        var str = 'Edit' + '<span style="font-weight: 400">' + tipName + '</span>' + 'Rated Value';

        //修改
        _moTaiKuang($('#edit-Modal'), str, '', '' ,'', 'Confirm');
        ...
        $.ajax({
            ...
            success:function(result){
                ...
                if(result.code == 0){
                    ...
                    _moTaiKuang($('#tip-myModal'),'Message',true,true,'Modification of rated load is successful','');

                }else{

                    _moTaiKuang($('#tip-myModal'),'Message',true,true,'Failure to modify rated load','');
