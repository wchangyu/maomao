...
function getOrganizationData(){
    ...
    if(!startTime || !endTime || startTime == '' || endTime == ''){                   _
        moTaiKuang($('#myModal2'), '提示', 'flag', 'istap' ,'请选择时间后查询', '');
        return false;
    }
    ...
    var url = 'Provincial/GetProvincialDistrictEnergyRank';
