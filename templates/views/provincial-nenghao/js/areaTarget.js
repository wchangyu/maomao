...
function getOrganizationData(){
    ...
    var url = 'Provincial/GetProvincialDistrictEnergyNorm';
    ...
    var successFun = function (result){
        ...
        var tableHeadHtml = "<tr><th>地区</th><th>建筑数量</th><th class='building-area'>建筑面积(㎡)</th><th class='people-num'>"+tablePeopleTitle+"</th>";
        ...
        tableHeadHtml += "<th>"+energyName+ "(" + unit+")</th>";


        tableHeadHtml += "<th>"+energyNormFlagName + "(" + energyNormFlagUnit+")</th></tr>";
        ...
        $(allData).each(function(i,o){
            ...
            if(o.returnOBJID != -1){
                ...
                allDataY.push(o.energyNormData.toFixed(2));
            }
            ...
            tableHtml += "<tr>" +
                            ...
                            "<td>"+ o.energyNormData.toFixed(2)+"</td>"+
                         "</tr>"
